...
const NewBlog: React.FC<IBlogProps> = (props) => {
  ...
  return (
    <form className=" d-flex justify-content-center align-items-center">
      <div className="form-group col-6 shadow-lg border text-white border-dark rounded mt-3 text-center" style={{backgroundColor: "#7952b3"}}>
        
        <label className="">Authored By:</label>
        <input
          type="text"
